...
export const TRANSLATIONS: Record<Lang, Dict> = {
  es: {
    ...
    'demo.cafe.desc': 'Sitio web para negocio de café o restaurante: menú digital por categoría, formulario de reserva y diseño mobile-first. Sin backend, carga instantánea.',
    ...
    'demo.consultorio.desc': 'Sitio web para consultorio médico o dental: servicios, equipo profesional, formulario de cita y diseño mobile-first. Sin backend, carga instantánea.',
  ...
  en: {
    ...
    'demo.cafe.title': 'Café',
    'demo.cafe.desc': 'Website for a café or restaurant: digital menu by category, reservation form and mobile-first design. No backend, instant load.',
    'demo.barber.title': 'Barbería',
    ...
    'demo.consultorio.title': 'Consultorio',
    'demo.consultorio.desc': 'Website for a medical or dental clinic: services, professional team, appointment form and mobile-first design. No backend, instant load.',
